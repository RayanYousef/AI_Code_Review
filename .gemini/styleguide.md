...
**CRITICAL**: When reviewing code, you MUST enforce ALL rules, principles, guidelines, and patterns documented in this entire document comprehensively and strictly.

- Review every aspect of the code against ALL sections in this document
- Check for violations of every rule, principle, guideline, code example pattern, and requirement specified in this document, regardless of which section it appears in
- Every "Don't" example represents a violation that must be flagged
- Every "Do" example represents the required pattern that must be enforced
- Be thorough and check all naming conventions, code structure requirements, design principles, and Unity-specific guidelines

For every violation found, cite line numbers, explain the issue, provide corrected code, and reference the specific guideline section from this document.
